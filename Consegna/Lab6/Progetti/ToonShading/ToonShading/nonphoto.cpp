...
static void init() {
    ...
    const GLfloat lightPos[4] = {0.0f, 3.0f, 3.0f, 1.0f};
    glLightfv(GL_LIGHT0, GL_POSITION, lightPos);
    glEnable(GL_LIGHTING);
    glEnable(GL_LIGHT0);
    glEnable(GL_DEPTH_TEST);
    
    program = initShader("/Università/Magistrale/Fondamenti di CG/Lab/Lab 6/ToonShading/ToonShading/v.glsl", "/Università/Magistrale/Fondamenti di CG/Lab/Lab 6/ToonShading/ToonShading/f.glsl");
}
